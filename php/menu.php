  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <a class="navbar-brand mt-2 mt-lg-0" href="#">
        <img
          src="https://media0.giphy.com/media/gEwRbygRCpBZFxVj4t/giphy.gif"
          height="40"
          alt="MDB Logo"
          loading="lazy"
        />
    ...
    <div class="d-flex align-items-center">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item">
          <a class="nav-link" href="#">olá, <?php echo $_SESSION["usuario"];?></a>
        </li>
      <!-- Avatar -->
      <div class="dropdown">
        <a
        ...
        >
          <img
            src="https://media.tenor.com/a5a4uCOYfygAAAAC/profile-picture-rock.gif"
